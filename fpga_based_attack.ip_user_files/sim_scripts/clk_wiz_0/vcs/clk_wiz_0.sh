...
#
# Script generated by Vivado on Wed Apr 17 12:48:48 +0200 2024
...
# script info
echo -e "clk_wiz_0.sh - Script generated by export_simulation (Vivado v2023.2.2 (64-bit)-id)\n"
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../aes_tdc.gen/sources_1/bd/jtag2pt/ipshared/c2c6" +incdir+"../../../../aes_tdc.gen/sources_1/ip/clk_wiz_0" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../aes_tdc.gen/sources_1/bd/jtag2pt/ipshared/c2c6" +incdir+"../../../../aes_tdc.gen/sources_1/ip/clk_wiz_0" \
