...
HD_PWD='D:/prj/vivado/aes_tdc_50_50_artix7/aes_tdc.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tdc.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tdc.tcl -notrace
