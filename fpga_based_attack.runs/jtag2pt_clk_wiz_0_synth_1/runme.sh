...
HD_PWD='D:/prj/vivado/aes_tdc_50_50_artix7/aes_tdc.runs/jtag2pt_clk_wiz_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log jtag2pt_clk_wiz_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source jtag2pt_clk_wiz_0.tcl
